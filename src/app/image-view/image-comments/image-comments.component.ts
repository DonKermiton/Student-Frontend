        ...
        this.route.queryParams
            .pipe(
                ...
                mergeMap((photo: photoModel) => {
                    ...
                    return this.posts.getSelectedPost(postID)
                }),
                mergeMap((post)=> {
                    this.postData = post;
                    return this.posts.getAllPostComments(postID);
                }),
                mergeMap((postComments) => {
                    this.postComments = postComments;
                    return this.photo.getPostPhotoCollection(postID);
                }),

            )
            .subscribe((photoCollection) => {
                console.log(photoCollection.length);
